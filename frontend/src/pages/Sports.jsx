  ...
  return (
    <div className="antialiased flex flex-col min-h-screen bg-[#0d0e12]">
      ...
      <section className="relative pt-32 pb-20 flex items-center justify-center border-b border-[#d4af37]/20">
        ...
        >
          <i className="fa-solid fa-dumbbell text-6xl gold-text mb-6"></i>
          ...
          <p className="text-xl md:text-2xl text-gray-300 font-bold leading-relaxed">
            لياقة بدنية، استجمام، وألعاب جماعية. وفرنا لك في أورا بيتش أحدث
            التجهيزات الرياضية العالمية لتنعم بنمط حياة صحي وحيوي.
          </p>
        </div>
      </section>

      {/* تفاصيل القسم الرياضي - كروت الخدمات */}
      <section className="py-16 px-6 max-w-6xl mx-auto flex-grow">
        ...
        >
          <div className="bg-[#15171c] border border-[#d4af37]/30 rounded-2xl p-8 hover:border-[#d4af37] transition-all duration-300 hover:-translate-y-2 shadow-lg">
            <i className="fa-solid fa-weight-hanging text-4xl gold-text mb-4"></i>
            <h3 className="font-cairo font-black text-2xl mb-3 text-white">
              صالة الألعاب البدنية
            </h3>
            <p className="text-gray-400 font-bold leading-loose">
              أجهزة "Technogym" العالمية، كادر تدريبي محترف، وبرامج تمرين مخصصة
              تضمن لك الوصول لأهدافك البدنية بأعلى كفاءة وخصوصية.
            </p>
          </div>

          <div className="bg-[#15171c] border border-[#d4af37]/30 rounded-2xl p-8 hover:border-[#d4af37] transition-all duration-300 hover:-translate-y-2 shadow-lg">
            <i className="fa-solid fa-swimming-pool text-4xl gold-text mb-4"></i>
            <h3 className="font-cairo font-black text-2xl mb-3 text-white">
              المرافق المائية والبادل
            </h3>
            <p className="text-gray-400 font-bold leading-loose">
              مسابح أولمبية مدفأة، وملاعب بادل (Padel) مجهزة بأرضيات احترافية،
              لتستمتع بممارسة رياضاتك المفضلة في أجواء عائلية راقية.
            </p>
          </div>
        </div>
        ...
        <div className="mt-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-300 font-bold leading-loose text-lg text-justify">
              في نادي أورا بيتش، الرياضة ليست مجرد تمرين، بل هي تجربة ترفيهية
              متكاملة. صممنا المرافق الرياضية لتلبي احتياجات المبتدئين
              والمحترفين على حد سواء، مع توفير مناطق مخصصة للنساء لضمان أعلى
              مستويات الراحة والخصوصية.
            </p>
            ...
            <ul className="space-y-4 mt-6 text-gray-400 font-bold">
              <li className="flex items-center gap-3">
                ...
                مدربين معتمدين دولياً لمتابعة تقدمك
              </li>
              <li className="flex items-center gap-3">
                <span className="flex items-center justify-center w-8 h-8 rounded-full border border-[#d4af37] text-[#d4af37] bg-[#d4af37]/10">
                  <i className="fa-solid fa-check"></i>
                </span>
                خزائن خاصة ومرافق استحمام فاخرة
              </li>
            </ul>
          </div>
